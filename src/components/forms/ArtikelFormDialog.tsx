...
import { WysiwygEditor } from "@/components/WysiwygEditor" // Import your WYSIWYG component
            ...
            <div className="space-y-2">
              ...
              <div className="min-h-[400px]">
                <WysiwygEditor
                  ...
                  placeholder="Masukkan konten artikel dengan formatting lengkap..."
                />
              </div>
            </div>
